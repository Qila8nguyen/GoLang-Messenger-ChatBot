...
var (
	...
	accessToken = "EAAHtjHAIKDYBAFAtiZBogE8plpeWOy0KwSYx7zYdtKWtt4vdcDrYjDP0ZBVakoL3UqH2g5UxG3PZCcdZBc7dGpVwizUbs0m3d4vuX6ZA7JsszHDx4Aybll31ah6UT5ZBzgqp8B7O39jaZCVCXEbw9eNn6meVkjx5gstmwkBUKV16mfbkryoa4NM"
	verifyToken = "messages"
	appSecret   = "47709397f53cec7f93ac69f88109b012"
)
...
func HandleVerification(w http.ResponseWriter, r *http.Request) {
	...
	q := r.URL.Query()
	log.Print(q.Get("hub.verify_token"), "\n")
